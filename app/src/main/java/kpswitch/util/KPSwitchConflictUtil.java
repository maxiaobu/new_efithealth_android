 ...
 */
package kpswitch.util;

import android.app.Activity;
import android.view.MotionEvent;
import android.view.View;

import kpswitch.handler.KPSwitchFSPanelLayoutHandler;
import kpswitch.handler.KPSwitchPanelLayoutHandler;
import kpswitch.handler.KPSwitchRootLayoutHandler;
 ...
 * the layout-conflict please Ref  {@link KPSwitchRootLayoutHandler}銆�
 * {@link KPSwitchPanelLayoutHandler}銆亄@link KPSwitchFSPanelLayoutHandler}
 * <p/>
...
public class KPSwitchConflictUtil {
     ...
     * attach the action by yourself with invoke methods manually: {@link #showPanel(View)}銆�
     * {@link #showKeyboard(View, View)}銆亄@link #hidePanelAndKeyboard(View)}, and in the case of don't
