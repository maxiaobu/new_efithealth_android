package com.efithealth.app.view.refreshlistview;
...
import com.efithealth.app.view.refreshlistview.Circle;
import com.efithealth.app.view.refreshlistview.Utils;
...
public class WaterDropView extends View {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Emojicon, 0, 0);
            try {
                ...
                if(a.hasValue(R.styleable.Emojicon_waterdrop_color)){
                   int waterDropColor =  a.getColor(R.styleable.Emojicon_waterdrop_color, Color.GRAY);
                    mPaint.setColor(waterDropColor);
                }
                if (a.hasValue(R.styleable.Emojicon_max_circle_radius)) {
                    mMaxCircleRadius = a.getDimensionPixelSize(R.styleable.Emojicon_max_circle_radius, 0);
                ...
                if (a.hasValue(R.styleable.Emojicon_min_circle_radius)) {
                    mMinCircleRaidus = a.getDimensionPixelSize(R.styleable.Emojicon_min_circle_radius, 0);
