...
public class FragmentNearbyPerson extends BaseFragment{
	private View v;
	private WebView wb;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		v=inflater.inflate(R.layout.fragment_nearby_person, container,false);
		return v;
	}
	
	@Override
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		wb=(WebView) v.findViewById(R.id.find_nearby_wb);
...
//				}
		...
		wb.loadUrl("file:///android_asset/peopelNearby.html"
