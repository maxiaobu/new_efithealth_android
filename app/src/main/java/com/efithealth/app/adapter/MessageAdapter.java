...
import com.efithealth.app.activity.AlertDialog;
import com.efithealth.app.activity.BaiduMapActivity;
import com.efithealth.app.activity.ChatActivity;
import com.efithealth.app.activity.ContextMenu;
import com.efithealth.app.activity.ShowBigImage;
import com.efithealth.app.activity.ShowNormalFileActivity;
import com.efithealth.app.activity.ShowVideoActivity;
import com.efithealth.app.activity.UserProfileActivity;
import com.efithealth.app.domain.User;
import com.efithealth.app.task.LoadImageTask;
import com.efithealth.app.task.LoadVideoImageTask;
import com.efithealth.app.utils.DateUtils;
import com.efithealth.app.utils.ImageCache;
...
import com.efithealth.app.view.RoundImageView;
...
public class MessageAdapter extends BaseAdapter{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if ((chatType == ChatType.GroupChat || chatType == ChatType.ChatRoom) && message.direct == EMMessage.Direct.RECEIVE){
			...
			if (t1-t2>2000) {
				getNickAndAvatar(message.getUserName());
				Log.i("djy", t1+";"+t2);
			}
		}
...
//	    	 User user = ((DemoHXSDKHelper)HXSDKHelper.getInstance()).getContactList().get(message.getFrom());
//	    	 String imgPath=user.getAvatar();
//		        ImageLoader.getInstance().displayImage(imgPath, imageView);
