	...
	public void getData(final DataCallBack dataCallBack) {
		...
		new Thread() {
			...
			public void run() {
				...
				if (map != null) {
					...
					if (keys != null) {
						...
						while (iterator.hasNext()) {
							...
							if (key.equals("file") || key.equals("imagefile")) {
								...
								try {
									...
									Log.e("ServiceBack", "key---->>>>" + key + "------value---->>>>" + value);
				...
				Log.d("======entity.toString()", entity.toString());
				...
				try {
					...
					if (response.getStatusLine().getStatusCode() == 200) {
						...
						Log.e("ServiceBack", "返回数据是------->>>>>>>>" + builder.toString());
